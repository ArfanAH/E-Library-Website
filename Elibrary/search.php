  ...
  <?php
	...
	if (mysqli_num_rows($result) > 0) {
        while ($fetch = mysqli_fetch_assoc($result)) {
            ...
            $link1 = '';
            if ($fetch['Catagory'] == 'Action') {
                $link1 ="book2.php?id=$fetch[id]";
            } elseif ($fetch['Catagory'] == 'Fiction') {
              $link1 ="book1.php?id=$fetch[id]";
            }
         
             echo "<div class='card1'>";
                echo"<div class='round'></div>";
                echo"<div class='content'>";
                  echo"<h2>$fetch[b_name]</h2>";
                  echo"<p style='text-align:justify'>$fetch[sortdes]</p>";
              
                  echo"<a href='$link1'>Read More</a>";
                echo"</div>";
                echo"<img src='$fetchsrc$fetch[b_img]'>";
              echo"</div>";
